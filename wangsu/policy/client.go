...
type GetPolicyResponse struct {
  ...
  Data *GetPolicyGetPolicyResponseData `json:"data,omitempty" xml:"data,omitempty" require:"true" type:"Struct"`
}
...
func (s *GetPolicyResponse) SetData(v *GetPolicyGetPolicyResponseData) *GetPolicyResponse {
  s.Data = v
  return s
}

type GetPolicyGetPolicyResponseData struct {
  // {"en":"Policy ID", "zh_CN":"策略ID"}
  PolicyId *string `json:"policyId,omitempty" xml:"policyId,omitempty" require:"true"`
...
func (s GetPolicyGetPolicyResponseData) String() string {
  return tea.Prettify(s)
}

func (s GetPolicyGetPolicyResponseData) GoString() string {
  return s.String()
}

func (s *GetPolicyGetPolicyResponseData) SetPolicyId(v string) *GetPolicyGetPolicyResponseData {
  s.PolicyId = &v
  return s
}

func (s *GetPolicyGetPolicyResponseData) SetPolicyName(v string) *GetPolicyGetPolicyResponseData {
  s.PolicyName = &v
  return s
}

func (s *GetPolicyGetPolicyResponseData) SetDescription(v string) *GetPolicyGetPolicyResponseData {
  s.Description = &v
  return s
}

func (s *GetPolicyGetPolicyResponseData) SetType(v string) *GetPolicyGetPolicyResponseData {
  s.Type = &v
  return s
}

func (s *GetPolicyGetPolicyResponseData) SetPolicyDocument(v string) *GetPolicyGetPolicyResponseData {
  s.PolicyDocument = &v
  return s
}
...
type CreatePolicyResponse struct {
  ...
  // {"en":"Detailed data on the results of the request", "zh_CN":"请求结果的详细数据"}
  Data *CreatePolicyCreatePolicyResponseData `json:"data,omitempty" xml:"data,omitempty" require:"true" type:"Struct"`
}
...
func (s *CreatePolicyResponse) SetData(v *CreatePolicyCreatePolicyResponseData) *CreatePolicyResponse {
  s.Data = v
  return s
}

type CreatePolicyCreatePolicyResponseData struct {
  // {"en":"Policy ID", "zh_CN":"策略ID"}
  PolicyId *string `json:"policyId,omitempty" xml:"policyId,omitempty" require:"true"`
}

func (s CreatePolicyCreatePolicyResponseData) String() string {
  return tea.Prettify(s)
}

func (s CreatePolicyCreatePolicyResponseData) GoString() string {
  return s.String()
}

func (s *CreatePolicyCreatePolicyResponseData) SetPolicyId(v string) *CreatePolicyCreatePolicyResponseData {
  s.PolicyId = &v
  return s
}
