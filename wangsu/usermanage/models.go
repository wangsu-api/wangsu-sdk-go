...
type ApiIamBatchattachorreclaimpolicy2subaccountDnaRequest struct {
  // {"en":"Sub account login name", "zh_CN":"子用户登录名"}
  LoginName *string `json:"loginName,omitempty" xml:"loginName,omitempty" require:"true"`
...
func (s ApiIamBatchattachorreclaimpolicy2subaccountDnaRequest) String() string {
  return tea.Prettify(s)
}

func (s ApiIamBatchattachorreclaimpolicy2subaccountDnaRequest) GoString() string {
  return s.String()
}

func (s *ApiIamBatchattachorreclaimpolicy2subaccountDnaRequest) SetLoginName(v string) *ApiIamBatchattachorreclaimpolicy2subaccountDnaRequest {
  s.LoginName = &v
  return s
}

func (s *ApiIamBatchattachorreclaimpolicy2subaccountDnaRequest) SetPolicyId(v []*int64) *ApiIamBatchattachorreclaimpolicy2subaccountDnaRequest {
  s.PolicyId = v
  return s
}

func (s *ApiIamBatchattachorreclaimpolicy2subaccountDnaRequest) SetType(v int) *ApiIamBatchattachorreclaimpolicy2subaccountDnaRequest {
  s.Type = &v
  return s
}

type ApiIamBatchattachorreclaimpolicy2subaccountDnaResponse struct {
...
func (s ApiIamBatchattachorreclaimpolicy2subaccountDnaResponse) String() string {
  return tea.Prettify(s)
}

func (s ApiIamBatchattachorreclaimpolicy2subaccountDnaResponse) GoString() string {
  return s.String()
}

func (s *ApiIamBatchattachorreclaimpolicy2subaccountDnaResponse) SetCode(v string) *ApiIamBatchattachorreclaimpolicy2subaccountDnaResponse {
  s.Code = &v
  return s
}

func (s *ApiIamBatchattachorreclaimpolicy2subaccountDnaResponse) SetMessage(v string) *ApiIamBatchattachorreclaimpolicy2subaccountDnaResponse {
  s.Message = &v
  return s
}

type ApiIamBatchattachorreclaimpolicy2subaccountDnaPaths struct {
}

func (s ApiIamBatchattachorreclaimpolicy2subaccountDnaPaths) String() string {
  return tea.Prettify(s)
}

func (s ApiIamBatchattachorreclaimpolicy2subaccountDnaPaths) GoString() string {
  return s.String()
}

type ApiIamBatchattachorreclaimpolicy2subaccountDnaParameters struct {
}

func (s ApiIamBatchattachorreclaimpolicy2subaccountDnaParameters) String() string {
  return tea.Prettify(s)
}

func (s ApiIamBatchattachorreclaimpolicy2subaccountDnaParameters) GoString() string {
  return s.String()
}

type ApiIamBatchattachorreclaimpolicy2subaccountDnaRequestHeader struct {
}

func (s ApiIamBatchattachorreclaimpolicy2subaccountDnaRequestHeader) String() string {
  return tea.Prettify(s)
}

func (s ApiIamBatchattachorreclaimpolicy2subaccountDnaRequestHeader) GoString() string {
  return s.String()
}

type ApiIamBatchattachorreclaimpolicy2subaccountDnaResponseHeader struct {
}

func (s ApiIamBatchattachorreclaimpolicy2subaccountDnaResponseHeader) String() string {
  return tea.Prettify(s)
}

func (s ApiIamBatchattachorreclaimpolicy2subaccountDnaResponseHeader) GoString() string {
  return s.String()
}
...
type QueryPolicyAttachedMainAccountOrSubAccountResponse struct {
  ...
  QueryPolicyAttachedMainAccountOrSubAccountPolicyDescribe []*QueryPolicyAttachedMainAccountOrSubAccountPolicyDescribe `json:"policyDescribe,omitempty" xml:"policyDescribe,omitempty" require:"true" type:"Repeated"`
...
func (s *QueryPolicyAttachedMainAccountOrSubAccountResponse) SetPolicyId(v int64) *QueryPolicyAttachedMainAccountOrSubAccountResponse {
  s.PolicyId = &v
  return s
}

func (s *QueryPolicyAttachedMainAccountOrSubAccountResponse) SetPolicyName(v string) *QueryPolicyAttachedMainAccountOrSubAccountResponse {
  s.PolicyName = &v
  return s
}

func (s *QueryPolicyAttachedMainAccountOrSubAccountResponse) SetPolicyDescribe(v []*QueryPolicyAttachedMainAccountOrSubAccountPolicyDescribe) *QueryPolicyAttachedMainAccountOrSubAccountResponse {
  s.QueryPolicyAttachedMainAccountOrSubAccountPolicyDescribe = v
  return s
}

func (s *QueryPolicyAttachedMainAccountOrSubAccountResponse) SetPolicyType(v string) *QueryPolicyAttachedMainAccountOrSubAccountResponse {
  s.PolicyType = &v
  return s
}

type QueryPolicyAttachedMainAccountOrSubAccountPolicyDescribe struct {
  // {"en":"Language type", "zh_CN":"语言类型"}
  LanguageCode *string `json:"languageCode,omitempty" xml:"languageCode,omitempty" require:"true"`
  // {"en":"Policy description", "zh_CN":"策略描述内容"}
  LanguageValue *string `json:"languageValue,omitempty" xml:"languageValue,omitempty" require:"true"`
}

func (s QueryPolicyAttachedMainAccountOrSubAccountPolicyDescribe) String() string {
  return tea.Prettify(s)
}

func (s QueryPolicyAttachedMainAccountOrSubAccountPolicyDescribe) GoString() string {
  return s.String()
}

func (s *QueryPolicyAttachedMainAccountOrSubAccountPolicyDescribe) SetLanguageCode(v string) *QueryPolicyAttachedMainAccountOrSubAccountPolicyDescribe {
  s.LanguageCode = &v
  return s
}

func (s *QueryPolicyAttachedMainAccountOrSubAccountPolicyDescribe) SetLanguageValue(v string) *QueryPolicyAttachedMainAccountOrSubAccountPolicyDescribe {
  s.LanguageValue = &v
  return s
}
...
func (s *ListAccountIdentResponse) SetAccessKey(v string) *ListAccountIdentResponse {
  s.AccessKey = &v
  return s
}

func (s *ListAccountIdentResponse) SetSecretKey(v string) *ListAccountIdentResponse {
  s.SecretKey = &v
  return s
}

func (s *ListAccountIdentResponse) SetStatus(v string) *ListAccountIdentResponse {
  s.Status = &v
  return s
}
