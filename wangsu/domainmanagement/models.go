...
func (s *DeleteCdnDomainServicePaths) SetDomain(v string) *DeleteCdnDomainServicePaths {
  s.Domain = &v
  return s
}
...
func (s *CreateDomainRequestLiveConfig) SetOriginIps(v string) *CreateDomainRequestLiveConfig {
  s.OriginIps = &v
  return s
}
