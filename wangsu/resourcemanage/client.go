...
type NodeRedundantBandwidth4PstatpResponse struct {
  ...
  // {"en":"no", "zh_CN":"带宽列表"}
  Data []*NodeRedundantBandwidth4PstatpNodeBandwidth `json:"Data,omitempty" xml:"Data,omitempty" require:"true" type:"Repeated"`
}
...
func (s *NodeRedundantBandwidth4PstatpResponse) SetData(v []*NodeRedundantBandwidth4PstatpNodeBandwidth) *NodeRedundantBandwidth4PstatpResponse {
  s.Data = v
  return s
}

type NodeRedundantBandwidth4PstatpNodeBandwidth struct {
  // {"en":"no", "zh_CN":"节点ID"}
  RoomId *string `json:"RoomId,omitempty" xml:"RoomId,omitempty" require:"true"`
  // {"en":"no", "zh_CN":"带宽列表"}
  NodeRedundantBandwidth4PstatpIspBandwidth []*NodeRedundantBandwidth4PstatpIspBandwidth `json:"NodeRedundantBandwidth4PstatpIspBandwidth,omitempty" xml:"NodeRedundantBandwidth4PstatpIspBandwidth,omitempty" require:"true" type:"Repeated"`
}

func (s NodeRedundantBandwidth4PstatpNodeBandwidth) String() string {
  return tea.Prettify(s)
}

func (s NodeRedundantBandwidth4PstatpNodeBandwidth) GoString() string {
  return s.String()
}

func (s *NodeRedundantBandwidth4PstatpNodeBandwidth) SetRoomId(v string) *NodeRedundantBandwidth4PstatpNodeBandwidth {
  s.RoomId = &v
  return s
}

func (s *NodeRedundantBandwidth4PstatpNodeBandwidth) SetIspBandwidth(v []*NodeRedundantBandwidth4PstatpIspBandwidth) *NodeRedundantBandwidth4PstatpNodeBandwidth {
  s.NodeRedundantBandwidth4PstatpIspBandwidth = v
  return s
}

type NodeRedundantBandwidth4PstatpIspBandwidth struct {
  // {"en":"no", "zh_CN":"运营商"}
...
func (s NodeRedundantBandwidth4PstatpIspBandwidth) String() string {
  return tea.Prettify(s)
}

func (s NodeRedundantBandwidth4PstatpIspBandwidth) GoString() string {
  return s.String()
}

func (s *NodeRedundantBandwidth4PstatpIspBandwidth) SetIsp(v string) *NodeRedundantBandwidth4PstatpIspBandwidth {
  s.Isp = &v
  return s
}

func (s *NodeRedundantBandwidth4PstatpIspBandwidth) SetCurrentBandwidth(v int) *NodeRedundantBandwidth4PstatpIspBandwidth {
  s.CurrentBandwidth = &v
  return s
}

func (s *NodeRedundantBandwidth4PstatpIspBandwidth) SetAvailableElasticBandwidth(v int) *NodeRedundantBandwidth4PstatpIspBandwidth {
