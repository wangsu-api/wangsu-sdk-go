...
| Queryaigatewayusage | This API is used to query the AI gateway usage data of customers at a specified granularity. Users can query by specifying parameters such as date range, aggregation granularity, region, acceleration type, service provider, gateway, and model. By default, the query will return the usage data of all AI gateways for the current day, including summary data and detailed data at a 5-minute granularity. | POST | /myview/sharkletAIgateway |