...
func (s CreateRuleCondition) String() string {
	return tea.Prettify(s)
}

func (s CreateRuleCondition) GoString() string {
	return s.String()
}

func (s *CreateRuleCondition) SetMonitorItem(v string) *CreateRuleCondition {
	s.MonitorItem = &v
	return s
}

func (s *CreateRuleCondition) SetCondition(v string) *CreateRuleCondition {
	s.Condition = &v
	return s
}

func (s *CreateRuleCondition) SetThreshold(v string) *CreateRuleCondition {
	s.Threshold = &v
	return s
}
...
type CreateRuleItem struct {
	...
	ConditionRules []*CreateRuleCondition `json:"conditionRules,omitempty" xml:"conditionRules,omitempty" require:"true" type:"Repeated"`
}

func (s CreateRuleItem) String() string {
	return tea.Prettify(s)
}

func (s CreateRuleItem) GoString() string {
	return s.String()
}

func (s *CreateRuleItem) SetStartTime(v string) *CreateRuleItem {
	s.StartTime = &v
	return s
}

func (s *CreateRuleItem) SetEndTime(v string) *CreateRuleItem {
	s.EndTime = &v
	return s
}

func (s *CreateRuleItem) SetConditionType(v string) *CreateRuleItem {
	s.ConditionType = &v
	return s
}

func (s *CreateRuleItem) SetPeriod(v int32) *CreateRuleItem {
	s.Period = &v
	return s
}

func (s *CreateRuleItem) SetPeriodTimes(v int32) *CreateRuleItem {
	s.PeriodTimes = &v
	return s
}

func (s *CreateRuleItem) SetConditionRules(v []*CreateRuleCondition) *CreateRuleItem {
	s.ConditionRules = v
	return s
}

// 通知方式
type CreateRuleNotice struct {
...
func (s CreateRuleNotice) String() string {
	return tea.Prettify(s)
}

func (s CreateRuleNotice) GoString() string {
	return s.String()
}

func (s *CreateRuleNotice) SetNoticeMethod(v string) *CreateRuleNotice {
	s.NoticeMethod = &v
	return s
}

func (s *CreateRuleNotice) SetNoticeObject(v string) *CreateRuleNotice {
	s.NoticeObject = &v
	return s
}
...
type CreateCloudMonitorRealTimeAlarmRuleRequest struct {
	...
	RuleItems []*CreateRuleItem `json:"ruleItems,omitempty" xml:"ruleItems,omitempty" require:"true" type:"Repeated"`
	// {"en":"Notification methods list", "zh_CN":"通知方式列表"}
	Notices []*CreateRuleNotice `json:"notices,omitempty" xml:"notices,omitempty" require:"true" type:"Repeated"`
}
...
func (s *CreateCloudMonitorRealTimeAlarmRuleRequest) SetRuleItems(v []*CreateRuleItem) *CreateCloudMonitorRealTimeAlarmRuleRequest {
	s.RuleItems = v
	return s
}

func (s *CreateCloudMonitorRealTimeAlarmRuleRequest) SetNotices(v []*CreateRuleNotice) *CreateCloudMonitorRealTimeAlarmRuleRequest {
	s.Notices = v
	return s
}

// 响应数据
type CreateMonitorRuleData struct {
	// {"en":"Rule ID", "zh_CN":"规则ID"}
	RuleId *string `json:"ruleId,omitempty" xml:"ruleId,omitempty" require:"true"`
}

func (s CreateMonitorRuleData) String() string {
	return tea.Prettify(s)
}

func (s CreateMonitorRuleData) GoString() string {
	return s.String()
}

func (s *CreateMonitorRuleData) SetRuleId(v string) *CreateMonitorRuleData {
	s.RuleId = &v
	return s
}
...
type CreateCloudMonitorRealTimeAlarmRuleResponse struct {
	...
	Data *CreateMonitorRuleData `json:"data,omitempty" xml:"data,omitempty" require:"true"`
}
...
func (s *CreateCloudMonitorRealTimeAlarmRuleResponse) SetData(v *CreateMonitorRuleData) *CreateCloudMonitorRealTimeAlarmRuleResponse {
	s.Data = v
	return s
}
